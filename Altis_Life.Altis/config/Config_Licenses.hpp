...
class Licenses {
	...
	class reserve {
        variable = "reserve";
        displayName = "STR_License_Reserve";
        price = 150000;
        illegal = false;
        side = "civ";
    };
	...
	class einbuergerung {
        ...
        displayName = "STR_License_Einbuergerung";
        price = 2500;
        illegal = false;
        side = "civ";
    };
	...
	class schwarz {
        variable = "schwarz";
        displayName = "STR_License_Schwarz";
        price = 2000000;
        illegal = true;
        side = "civ";
    };
	...
	class sniper {
        variable = "sniper";
        displayName = "STR_License_Sniper";
        price = 8000;
        illegal = false;
        side = "cop";
    };
