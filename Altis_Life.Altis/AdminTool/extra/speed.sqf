		...
		if(isEngineOn _vehicle_player) then 
		{
			switch (_this) do 
			{
				case 18: /* KEY E */
				{
					...
					{
						_vehicle_player SetVelocity [(velocity _vehicle_player select 0) * 1.07, (velocity _vehicle_player select 1) *1.07, (velocity _vehicle_player select 2) * 0.99];
					} 
					else 
					{
				...
				case 42: /* KEY SHIFTL */
				{
					...
					{
						_vehicle_player setVelocity [(velocity _vehicle_player select 0) * 1.1, (velocity _vehicle_player select 1) * 1.1, (velocity _vehicle_player select 2) * 0.99];
					} 
					else 
					{
