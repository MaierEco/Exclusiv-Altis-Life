...
switch (_type) do
{
    ...
    {    
        ...
        { _boxn addWeaponCargo [_x,5]; } foreach _weapons;
        ...
        { _boxn addItemCargo [_x,1]; } foreach _items;
        ...
        { _boxn addBackPackCargo [_x,10]; } foreach _backpacks;
    };
    ...
    {    
        ...
        { _boxn addItemCargo [_x,10]; } foreach _items;
    };
...
if(_resupply) then
{
    ...
    [_boxn,_type,_resupply,_resupply_time] execVM "_src\fillCrate.sqf";