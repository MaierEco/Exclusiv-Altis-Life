...
if (HaxSmokeOn==0) then
{
	...
	_sCode = _sCode + 'Flare7 = "SmokeShellpurple" createVehicle position vehicle player;Flare7 attachTo [vehicle player,[4,0,0]];';
	_sCode = _sCode + 'Flare8 = "SmokeShellgreen" createVehicle position vehicle player;Flare8 attachTo [vehicle player,[-4,0,0]];';
